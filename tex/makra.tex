...
\usepackage[section]{placeins} % keeps floats from drifting past \section breaks
\newenvironment{tablenotes}{\par\smallskip\small\let\item\relax}{} % lightweight table notes
\makeatletter
