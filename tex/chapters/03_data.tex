...
% - Full-text filings for textual analysis (Item 1A Risk Factors)
%
% \subsection{Stock Market Data}
% - Source: yfinance (adjusted close prices)
% - Volatility: annualised std of daily log returns over post-filing windows
%   (5, 10, 30, 90, 180, 365 days)
%
...
% - Item 1A length: ln(Words^{1A}) (H1, volume channel)
% - Item 1A risk-word density: LM uncertainty + litigious counts /
%   total words (H2, specificity channel)
%
% \section{Dependent Variable}
% - log(annualised post-filing volatility) over 5/10/30/90/180/365 day
%   windows starting two trading days after filing
%
% \section{Panel Data Construction}
% - Annual panel: ~6,300 firm-years; ~5,690 with valid Item 1A text
%
% \section{Descriptive Statistics}
% - Summary statistics, correlation matrix (in Chapter 5)
...
19\,\% of the 539-firm panel and span the full history of SEC filing
formats.
